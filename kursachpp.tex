...
\begin{figure}[h!]
\center{\includegraphics[width=.9\linewidth]{hiptgasra}}\\{Распределение звезд из объединённого каталога на небесной сфере в экваториальной СК}
%\label{img:hiptgasra}
\end{figure}
\end{frame}	
...
\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{hammtiss}}\\{Проекция Хаммер-Айтофа с эллипсами равных площадей}
\label{img:hammtiss}
\end{figure}
\end{frame}	
...
\begin{frame}[<alignment>]
\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{b3erra}}\\{Распределение объектов, для которых модуль разности параллаксов больше 3 ошибок, на небесной сфере в экваториальной СК. Красные (1262) - положительные по знаку разности параллаксов, синие (692)- отрицательные.}
...
\begin{frame}[<alignment>]
\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{b3sra}}\\{Распределение объектов, для которых модуль разности параллаксов больше 3 среднеквадратических отклонений, в экваториальной СК. Красные (601) - положительные разности параллаксов, синие (272) - отрицательные.}
%\label{img:abs_paralax}
\end{figure}
\end{frame}	
...
\begin{figure}[h!]
\center{\includegraphics[width=.57\linewidth]{hprs999}}\\{Гистограмма выбросов}
%\label{img:abs_paralax}
\end{figure}
\end{frame}
...
\begin{figure}[h!]
\center{\includegraphics[width=1.\linewidth]{h75ra}}\\{Распределение выбросов модуля разности параллаксов экваториальной СК. Красные (81) - положительные по знаку разности параллаксов, синие (9) - отрицательные.}
\end{figure}
\end{frame}
...
\begin{figure}[h!]
\center{\includegraphics[width=0.5\linewidth]{healpix}}\\{Пимер деления сферы по часовой начиная с верхнего левого на 12, 48, 192 и 768 пикселей}
\label{img:healpix}
\end{figure}
...
\begin{figure}[h!]
\center{\includegraphics[width=.85\linewidth]{sf_lo}}\\{Распределение среднемедианного модуля разности параллаксов на небесной сфере в эклиптической СК}
...
\begin{figure}[h!]
\center{\includegraphics[width=.85\linewidth]{sf_j_p}}\\{Коэффиценты разложения модуля разности параллаксов по сферическим функциям в эклиптической СК}
\label{img:sf_j}
\end{figure}
\end{frame}	
...
\frametitle{Сферические гармоники}
\begin{figure}[h!]
\center{\includegraphics[width=0.85\linewidth]{sffff}}\\{Распределение значимых гармоник модуля разности параллаксов по небесной сфере в эклиптической СК}
%\label{img:sfff}
\end{figure}
\end{frame}	
...
\frametitle{Сферические гармоники}
\begin{figure}[h!]
\center{\includegraphics[width=0.85\linewidth]{sffff_err}}\\{Распределение значимыхе гармоник ошибки разности параллаксов по небесной сфере в эклиптической СК}
%\label{img:sfff}
\end{figure}
\end{frame}	
...
\frametitle{Сферические гармоники}
\begin{figure}[h!]
\center{\includegraphics[width=0.85\linewidth]{nobs}}\\{Распределение числа наблюдения звезд Hipparcos в эклиптической СК}
%\caption{}
%\label{img:nobs}
\end{figure}
\end{frame}	
...
\frametitle{Сферические гармоники}
\begin{figure}[h!]
\center{\includegraphics[width=0.85\linewidth]{sf_j_dd}}\\{Распределение значимыхе гармоник cреднеквадратичного отклонения разности параллаксов по небесной сфере в эклиптической СК}
%\label{img:sfff}
\end{figure}
\end{frame}	
...
\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{GDR2_fluxRGB_hammer_4000x2000}}
...
%\frametitle{Визуализация распределения}
\begin{figure}[h!]
\center{\includegraphics[width=1\linewidth]{hiptgasl}}\\{Распределение в галлактической СК}
\label{img:hiptgasl}
\end{figure}
\end{frame}	
...
%\frametitle{Визуализация распределения}
\begin{figure}[h!]
\center{\includegraphics[width=1.\linewidth]{hiptgaslo}}\\{Распределение в эклиптической СК}
\label{img:hiptgaslo}
\end{figure}
\end{frame}	
...
%\frametitle{Случайные выбросы}
\begin{figure}[h!]
\center{\includegraphics[width=1.\linewidth]{75maxlb}}\\{Распределение рекордсменов в галактической СК Красные - положительные, синие - отрицательные.}
\label{img:75maxlb}
\end{figure}
\end{frame}
...
%\frametitle{Случайные выбросы}
\begin{figure}[h!]
\center{\includegraphics[width=1.\linewidth]{75maxlonlat}}\\{Распределение рекордсменов в эклиптической СК Красные - положительные, синие - отрицательные.}
...
\begin{figure}[h!]
\center{\includegraphics[width=0.7\linewidth]{sf_ra}}\\{Распределение модуля параллаксов в экваториальной СК }
\label{img:sf_ra}
\end{figure}
\end{frame}	
...
\frametitle{Распределение}
\begin{figure}[h!]
\center{\includegraphics[width=0.7\linewidth]{sf_l}}\\{Распределение модуля параллаксов в галактической СК}
\label{img:sf_l}
\end{figure}
...
\frametitle{Сферические гармоники}
\begin{figure}[h!]
\center{\includegraphics[width=0.85\linewidth]{sf_j_err}}\\{Коэффиценты разложения ошибки разности параллаксов на сферические функции по небесной сфере в эклиптической СК}
%\label{img:sfff}
\end{figure}
...
\frametitle{Сферические гармоники}
\begin{figure}[h!]
\center{\includegraphics[width=0.85\linewidth]{sf_j_d}}\\{Коэффиценты разложения среднеквадратичного отклонения разности параллаксов на сферические функции в эклиптической СК}
%\label{img:sfff}
\end{figure}
\end{frame}	
